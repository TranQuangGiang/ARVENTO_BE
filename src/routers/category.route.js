 ...
 */
router.post('/admin', authMiddleware.authenticateToken, authMiddleware.authorizeRoles(Roles.ADMIN), categoryController.createCategory);
/**
 * @swagger
 * /categories/admin/{id}:
 *  put:
 ...
 */
router.put('/admin/:id', authMiddleware.authenticateToken, authMiddleware.authorizeRoles(Roles.ADMIN), categoryController.updateCategory);
/**
 * @swagger
 * /categories/admin/{id}:
 *  delete:
